...
$(document).ready(function () {
    ...
    $("#productos").on('click', '.btn-quitar-producto', function(){
...
$('body').on('click','#selecionarProductoBtn',function () {
    let id = $("#selectOptionIdProducto.last").val();
    if(id != ""){
