<?php
    ...
    if(isset($_POST['linea'])){
      ...
      echo "<div class='row'><select class='form-control col-sm-10' id='selectOptionIdProducto' name='selectOptionIdProducto'>";
      ...
      echo "</select>
            <button type='button' class='btn btn-info col-sm-2' id='selecionarProductoBtn' name='selecionarProductoBtn'>Seleccionar</button>
            </div>";
    }else{
        echo "<h5>".$marca."</h5>";
