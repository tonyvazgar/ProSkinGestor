...
<body style='background-color: #f9f3f3;'>
    <?php
        ...
        $infoCliente = $ModelCliente->getMonederoWhereID($idMonedero)[0];
        // print_r($infoCliente);
    ?>
        ...
        <div class="container">
            ...
            <form action="recargarMonedero.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="dineroTotal" name="dineroTotal" placeholder="Cantidad del valor de los nuevos tratamientos" autocomplete="off" required>
                </div>
